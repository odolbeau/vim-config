...
" PHP syntax: comments {{{1
  ...
  if version >= 600
    ...
    syn match phpComment "//.\{-}$"        contained
    syn uster phpClExpressions add=phpBacktick
...
" PHP syntax: strings: special sequences {{{1
  ...
  " create an identifier ingsWithIdentifiers
...
" PHP syntax: variables/identifiers ($foo) {{{1
  ...
  syn match phpIdentifier /\$\$\+\h\w|GLOBALS\)\>/
...
" PHP Syntax: function/static calls: {{{1
  ...
  " places, rather than less, so I have just added theions add=@phpClFunctions
...
"              \ matchgroup=phpHTMLError end=/?>/
        ...
        " TODO: thoroughlyhile skipwhite skipempty
"               \ matchgroup=phpHTMLError end=/?>/
                \ fold
...
" PHP Syntax: semicolons: {{{1
  ...
  if s:show_semicolon
    " highlight the semicolon anywhere it appears i^ < > , ? :
...
" PHP Syntax: constants: {{{1
  ...
  " TODO: check these against the latest PHP manual
    ...
    syn keyword phpCoreConstant contained FILE_APPEND FILE_IGNORE_NEW_LINES FILE_NO_DEFAULT_CONTEXT FILE_SKIP_EMPTY_LINES FILE_USnstant contained INF
    ...
    syn keyword phpCoreConstant contained STREAM_CLIENT_ASYNC_CONNECT STREAM_CLIENT_CONNECT STREAM_CLIENT_PER_CRYPTO_METHOD_SSLv3_CLIENT STREAM_CRYPTO_METHOD_SSLv3_SERVER STREAM_CRYPTO_METHOD_TLS_CLIENT STREAM_CRYPTO_METHOD_TLS_SERVER
    ...
    syn keyword phpCoreConstantined XML_ENTITY_DECL_NODE XML_ENTITY_NODE XML_ENTITY_REF_NODE XML_ERROR_ASYNC_ENTITY XML_ERROR_ATTRIBUTE_EXTERNAL_ENTITY_REF XML_ERROR_BAD_CHAR_REF
...
" PHP Syntax: functions {{{1
  ...
  " BBCode
  syn keyword phpCoreConstant contained BBCODE_TYPE_NOARG BBCODE_TYPE_SINGLE BBCODE_TYPE_ARG BBCODE_TYPE_OPTARG BBCODE_TYPE_ROOT BBCODE_FLAGS_ARG_PARSING BBCODE_FLAGS_CDATA_NOT_ALLOWED BBCODE_FLAGS_SMILEYS_ON BBCODE_F BBCODE_AUTO_CORRECT BBCODE_CORRECT_REOPEN_TAGS BBCODE_DISABLE_TREE_BUILD BBCODE_DEFAULT_SMILEYS_ON BBCODE_DEFAULT_SMILEYS_OFF BBCODE_FORCE_SMILEYS_OFF BBCODE_SMILEYS_CASE_INSENSITIVE BBCODE_SET_FLAGS_SET BBCODE_SET_FLAGS_ADD BBCODE_SET_FLAGS_REMOVE
  ...
  syn keyword phpFunctions contained call_user_func_array call_user_func create_function func_get_arg func_get_args func_num_aphpCoreConstant contained GEOIP_COUNTRY_EDITION GEOIP_REGION_EDITION_REV0 GEOIP_CITY_EDITION_REV0 GEOIP_ORG_EDITION GEOIP_ISP_EDITION GEOIP_CITY_EDITION_REV1 GEOIP_REGION_EDITION_REV1 GEOIP_PROXY_EDITION GEOIP_ASNUM_EDITION GEOIP_NETSPEED_EDITION GEOIP_DOMAIN_EDITION GEOIP_UNKNOWN_SPEED GEOIP_DIALUP_SPEED GEOIP_CABLEDSL_SPEED GEOIP_CORPORATE_SPEED
  ...
  syn keyword phpFunctions contained imagefontwidth imageftbbox imagefttext imagegammacorrect imagegd2 imagegd imagegif imagegrabscreen imagegrabwindow imageinterlace imageistruecolor imagejpeg imagelayereffect imageline imageloadfont imagepalettecopy imagepng imagepolygon imagepsbbox imagepsencodefont imagepsextendfont imagepsfreefont imagepsloadfont imagepsslantfont imagepstext imagerectangle imagerotate magettfbbox imagettftext imagetypes imagewbmp imagexbm iptcembed iptcparse jpeg2wbmp png2wbmp
  ...
  syn keyword phpCoreConstant contaihpFunctions contained abs acos acosh asin asinh atan2 atan atanh base_convert bindec ceil cos cosh decbin dechex decoct deg2rad exp expm1 floor fmod getrandmax hexdec hypot is_finite is_infinite is_nan lcg_value log10 log1p log max min mt_getrandmax mt_rand mt_srand octdec pi pow rad2deg rand round sin sinh sqrt srand tan tanh
  ...
  syn keyword phpFunctions contained msession_connect msession_count msessi msession_list msession_listvar msession_lock msession_plugin msession_randstr msession_set_array msession_set_data msession_set msession_timeout msession_uniq msession_unlock
  ...
  syn keyword phpCoreConstant contained NCURSES_KEY_SAVE NCURSES_KEY_SBEG NCURSES_KEY_SCANCEL NCURSES_KEY_SCOMMAND NCURSES_KEY_SCOPY NCURSES_KEY_SCREATE NCURSES_KEY_SDC NCURSES_KEY_SDL NCURSES_KEY_SELECT NCURSES_KEY_SEND NCURSES_KEY_SEOL NCURSES_KEY_SEXIT NCURSES_KEY_SFIND NCURSES_KEYES_KEY_SPREVIOUS NCURSES_KEY_SPRINT NCURSES_KEY_SREDO NCURSES_KEY_SREPLACE NCURSES_KEY_SRIGHT NCURSES_KEY_SRSUME NCURSES_KEY_SSAVE NCURSES_KEY_SSUSPEND NCURSES_KEY_UNDO NCURSES_KEY_MOUSE NCURSES_KEY_MAX
  " Mouse
  ...
  syn keyword   phpFunctem  contained
  ...
  syn keyword   phpMethods  key langdepvalue value values checkin checkout children mimetype readlection insertdocument link lock move assign attreditable count insert remove title value object objectbyanchor parents description type remove replace setcommitedversion srcanchors srcsofdst unlock user userlist   contained
  ...
  syn keyword   phpFunctions    abs acos acosh asin asinh atan2 atan atanh base_convert bindec ceil cos cosh decbin dechex decoct deg2rad exp expm1 floor fmod getrandmax hexdec hypot is_finite is_infinite is_nan lcg_value log10 log1p log max min mt_getrandmax mt_rand mt_srand octdec pi pow rad2deg rand round ables mb_decode_mimeheader mb_decode_numericentity mb_detect_encoding mb_detect_order mb_encode_mimeheader mb_encode_numericentity mb_ereg_match mb_ereg_replace mb_ereg_search_getpos mb_ereg_search_getregs mb_ereg_search_init mb_ereg_search_pos mb_ereg_search_regs mb_ereg_search_setpos mb_ereg_search mb_ereg mb_eregi_replace mb_eregi mb_get_info mb_http_input mb_http_output mb_internal_encoding mb_language mb_output_handler mb_parse_str mb_preferred_mime_name mb_regex_encoding mb_regex_set_options mb_send_mail mb_split mb_strcut mb_strimwidth mb_strlen mb_strpos mb_strrpos mb_strtolower mb_strtoupper mb_strwidth mb_substitute_character mb_substr_count mb_substr contained
  ...
  syn keyword   phpMethods  getHeightaddEntry getshape1 getshape2 add nextframe output remove save setbackground setdimension setframes setrate streammp3 addFill drawCurve drawCurveTo drawLine drawLineTo movePen movePenTo setLeftFill setLine setRightFill add nextframe remove setframes addString getWidth moveTo setColor setFont setHeight setSpacing addstring align setbounds setcolor setFont setHeight setindentation setLeftMargin setLineSpacing setMargins setname setrightMargin    contained
  ...
  syn keyword   phpFunctions    notes_body notes_copy_db notes_create_db notes_createst_headers nsapi_response_headers nsapi_virtual    contained
  ...
  syn keyword   phpFunctions    readline_add_history readline_clear_history readline_completion_function readline_info readline_list_history readline_read_history readained
  ...
  syn keyword   phpFunctions    xmlrpc_decode_request xmlrpc_decode xmlrpc_encode_request xmlrpc_encode xmlrpc_get_type xmlrpc_parse_method_descriptions xmlrpc_server_add_introspection_data xmlrpc_server_call_method xmlrpc_server_create xmlrpc_server_destroy xmlrpc_server_register_introspection_callback xmlrpc_server_register_method xmlrpc_serror_handler xslt_set_log xslt_set_sax_handler xslt_set_sax_handlers xslt_set_scheme_handler xslt_set_scheme_handlers   contained
...
if s:alt_arrays
  ...
  syn keyword phpList contaise of the '=>' operator
...
if s:strict_blocks
  ...
  " parenthesis for a d be bad, because it is possible for that to be spread over several
...
" PHP Region
if s:long_tags
  syn region phpRegion matchgroup=phpRegionDelimiter start=/<?phndif
...
if s:strict_blocks
  ...
  " III MATCH: class myFoo extends baseFoo <implements foo, Iterator> { }: {{{3
      ...
      syn cluster phpClDefineClassImplements add=phpDefineClassImplementpComment
            \ nextgroup=@phpClDefineClassImplements skipwhite skipempty
  ...
  " III MATCH: function & <somefunc>($a = 0, &$b) { }: {{{3
    ...
    " what can go inside a functition names.
...
"    endif
  ...
  " a 'nextgroup=phpDefineMethodProto' argument!
    ...
    " making more stuff to have a special 'metho, because
  ...
  " match one line constructs here and skip them at folding
    ...
    syn region  phpFoldInterface    matchgroup=Structure start="^\z(\s*\)interface\s\+\([^}]egion   phpFoldCatch    matchgroup=Exception start="^\z(\s*\)catch\%([^}]*$\)\@=" matchgroup=Delimiter end="^\z1}" contains=@phpClFunction,phpFoldFunction contained transparent fold extend
...
" TODO: convert 'echo' and 'include' to regions so that it cannot contain other add=phpEchoRegion
if s:strict_blocks
...
"syn cluster phpClExprens=phpPropertySelector,phpIdentifier,@phpClProperties
"syn match phpPropertySelector /->/ contained display
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  "   will revert back to under deford')
...
if s:show_pcre
    ...
    " }}Q
      ...
      syn match pregEscapnedin=pregEscapeUnknown display
    ...
    " 5) Look for sub-patterns {{{
      ...
      syn match pregParens /(?<[=!]/ contained containedin=@pregPattern_Q dispnedin=@pregPattern_Q display extend
...
"              \ contained contains=@phpPREGString_any
        ...
        " TODO: ay contained nextgroup=phpPREGArrayOpenParent
...
"        \ contains=phpIdentifierInString,phpIdentifierInStringComplex
    ...
    " 8) Look for character classes {{{
      ...
      execute substituteff the character class
    ...
    " 9) Look for escaping using \Q and \E {{{
      ...
      hi link pregNonSpecial prentained containedin=pregNonSpecial_S display
